...
<h3 align="center">多功能、轻量化、高性能的 macOS 屏幕录制工具<br><a href="./README.md">[English Version]</a><br><a href="https://lihaoyun6.github.io/screenlapse/">[软件主页]</a>
</p>
...
<picture>
  ...
  <img alt="ScreenLapse Screenshots" src="./img/preview.png" width="840"/>
</picture>
</p>
...
## 常见问题
**1. 主面板关闭之后在哪里重新打开?**  
> 单击 ScreenLapse 的 Dock 栏图标即可随时重新呼出主功能面板.  

**2. 为什么 ScreenLapse 不是沙盒 App?**  
> 苹果沙盒权限管理机制比较复杂, 使用起来麻烦. 加之 ScreenLapse 并没有上架 App Store的打算, 故没有做成沙盒 App.

**3. 如何在后期剪辑中独立控制系统声音和麦克风录音的音量?**
> ScreenLapse 默认会在录制结束后将麦克风输入的音频合并到主音轨. 如果需要后期编辑的话, 可以在设置面板中关闭 `将麦克风录制到主音轨` 选项. 关闭后系统声音和麦克风将分别录制为两条音轨, 可以独立编辑.  
